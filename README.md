...
畫面中的行程全部是用上方那一行「快速新增」打自然語言加進去的，例如
`今天下午2點 專案驗收`、`明天上午10點 牙醫回診`。

![週檢視](docs/screenshots/week.png)

週檢視：7 欄時間格，可拖曳改時間、拖曳邊緣調長度、橫向拖曳換日，皆吸附 15 分鐘。

六套外觀主題 × 跟隨系統／淺色／深色，於「設定」切換並保存：
